...
const bankList = [
  { name: '기업은행', value: '03', imgName: 'ibk', disabled: false },
  { name: '국민은행', value: '04', imgName: 'kb', disabled: false },
  { name: '수협중앙회', value: '11', imgName: 'suhyup', disabled: false },
  {
    name: '지역농협',
    value: '12',
    imgName: 'nonghyup',
  ...
  { name: '우리은행', value: '20', imgName: 'woori', disabled: false },
  { name: 'SC은행', value: '23', imgName: 'sc', disabled: false },
  { name: '한국씨티은행', value: '27', imgName: 'citi', disabled: false },
  { name: '대구은행', value: '31', imgName: 'dgb', disabled: false },
  { name: '부산은행', value: '32', imgName: 'bnk', disabled: false },
  { name: '광주은행', value: '34', imgName: 'kwangju', disabled: false },
  { name: '제주은행', value: '33', imgName: 'shinhan', disabled: false },
  { name: '전북은행', value: '37', imgName: 'kwangju', disabled: false },
  { name: '새마을금고중앙회', value: '45', imgName: 'mg', disabled: false },
  { name: '신협중앙회', value: '48', imgName: 'shinhyup', disabled: false },
  { name: '상호저축은행', value: '50', imgName: 'fsb', disabled: false },
  { name: '우체국', value: '71', imgName: 'post', disabled: false },
  { name: 'KEB하나은행', value: '81', imgName: 'hana', disabled: false },
  { name: '신한은행', value: '88', imgName: 'shinhan', disabled: false },
  { name: '케이뱅크', value: '89', imgName: 'kbank', disabled: false },
  { name: '카카오뱅크', value: '90', imgName: 'kakao', disabled: false },
];
const cardList = [
...
const difficultNaverList = [
  {
    ...
    subTitle: (
      <>
        인증서가 없는 네이버 ID로 로그인 되어 있으면 인증이 제대로 작동하지
        않아요. 다른 브라우저에서 시도해 주시거나, 네이버 로그인을 다시 진행해
        주세요.
      </>
    ),
    checked: true,
  ...
  },
  {
    ...
    subTitle: (
      <>
        인증서 발급 후에 앱을 재설치 했거나, 핸드폰 잠금 정보가 달라지면
        인증서를 재발급 받아야 해요.
      </>
    ),
    checked: false,
...
const monthList = [
  { label: '01', value: '01', rating: 'safe' },
  { label: '02', value: '02', rating: 'safe' },
  { label: '03', value: '03', rating: 'safe' },
  { label: '04', value: '04', rating: 'safe' },
  { label: '05', value: '05', rating: 'safe' },
  { label: '06', value: '06', rating: 'safe' },
  { label: '07', value: '07', rating: 'safe' },
  { label: '08', value: '08', rating: 'safe' },
  { label: '09', value: '09', rating: 'safe' },
  { label: '10', value: '10', rating: 'safe' },
  { label: '11', value: '11', rating: 'safe' },
...
const yearList = [
  ...
  { label: '2025', value: '2025', rating: 'safe' },
  { label: '2026', value: '2026', rating: 'safe' },
  { label: '2027', value: '2027', rating: 'safe' },
  { label: '2028', value: '2028', rating: 'safe' },
  { label: '2029', value: '2029', rating: 'safe' },
  { label: '2030', value: '2030', rating: 'safe' },
  { label: '2031', value: '2031', rating: 'safe' },
  { label: '2032', value: '2032', rating: 'safe' },
  { label: '2033', value: '2033', rating: 'safe' },
];
const family = [
  { label: '부모', value: '부모', rating: 'safe' },
  { label: '자녀', value: '자녀', rating: 'safe' },
  { label: '배우자', value: '배우자', rating: 'safe' },
];
const initialState = {
  ftpImgUrls: [],
  feeId: '',
