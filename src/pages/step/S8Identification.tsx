    ...
    <Main>
      <div className={``}>
        <h2 className={`${styles.stepTitle}`}>
          {s5PersonalInfo?.userName || '고객'}님의 신분증 <br /> 정보를 입력해주세요
        </h2>
        ...
        <div className={`${styles.usimSubTitle} flex justify-items-center`}>
          ...
          <div
            ...
            onMouseOver={(e) => {
              ...
              // const { offsetTop, offsetLeft, offsetBottom, offsetRight } = svg.current as any;
              // console.log(offsetTop, offsetLeft, offsetBottom, offsetRight);
